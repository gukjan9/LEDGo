...
void blockBlink(){
  ...
  while(i>=2){
    int ledarr[4] = {calcLED(1,i), calcLED(1,i-1), calcLED(2,i), calcLED(2,i-1)};
...
void loop() {
  ...
  showBlockcolor2(1, 5);
  showBlockcolor1(1, 9);
  showBlockcolor2(1, 13);
  showBlockcolor1(1, 17);
  showBlockcolor2(1, 21);

  showBlockcolor1(5, 1);
  showBlockcolor2(5, 5);
  showBlockcolor1(5, 9);
  showBlockcolor2(5, 13);
  showBlockcolor1(5, 17);
  showBlockcolor2(5, 21);

  showBlockcolor1(9, 1);
  showBlockcolor2(9, 5);
  showBlockcolor1(9, 9);
  showBlockcolor2(9, 13);
  showBlockcolor1(9, 17);
  showBlockcolor2(9, 21);

  showBlockcolor1(13, 1);
  showBlockcolor2(13, 5);
  showBlockcolor1(13, 9);
  showBlockcolor2(13, 13);
  showBlockcolor1(13, 17);
  showBlockcolor2(13, 21);

  showBlockcolor1(17, 1);
  showBlockcolor2(17, 5);
  showBlockcolor1(17, 9);
  showBlockcolor2(17, 13);
  showBlockcolor1(17, 17);
  showBlockcolor2(17, 21);

  showBlockcolor1(21, 1);
  showBlockcolor2(21, 5);
  showBlockcolor1(21, 9);
  showBlockcolor2(21, 13);
  showBlockcolor1(21, 17);
  showBlockcolor2(21, 21);
  
  showBlockcolor1(25, 1);
  showBlockcolor2(25, 5);
  showBlockcolor1(25, 9);
  showBlockcolor2(25, 13);
  showBlockcolor1(25, 17);
  showBlockcolor2(25, 21);
