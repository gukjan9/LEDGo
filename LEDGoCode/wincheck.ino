...
void right_1(){                        //우3
  ...
  for(; a<=A+3; a++){
    ...
    if(cnt==4){
      ...
      showBlockcolor(4*(a+1)+1, 4*b+1, C0);
      showBlockcolor(4*(a+2)+1, 4*b+1, C0);
      showBlockcolor(4*(a+3)+1, 4*b+1, C0);
      blinkWinBlock(4*a+1, 4*(a+1)+1, 4*(a+2)+1, 4*(a+3)+1, 4*b+1, 4*b+1, 4*b+1, 4*b+1, C0);
      gamestatus = 5;
...
void right_2(){                      //좌1우2
  ...
  for(; a<=A+3; a++){
    ...
    if(cnt==4){
      ...
      showBlockcolor(4*(a+1)+1, 4*b+1, C0);
      showBlockcolor(4*(a+2)+1, 4*b+1, C0);
      blinkWinBlock(4*(a-1)+1, 4*a+1, 4*(a+1)+1, 4*(a+2)+1, 4*b+1, 4*b+1, 4*b+1, 4*b+1, C0);
      gamestatus = 5;
      Serial.println("Game End");
      Serial.println("***********************************");
   }
...
void right_3(){                      //좌2우1
  ...
  for(; a<=A+3; a++){
    ...
    if(cnt==4){
      ...
      showBlockcolor(4*a+1, 4*b+1, C0);
      showBlockcolor(4*(a+1)+1, 4*b+1, C0);
      blinkWinBlock(4*(a-2)+1, 4*(a-1)+1, 4*a+1, 4*(a+1)+1, 4*b+1, 4*b+1, 4*b+1, 4*b+1, C0);
      gamestatus = 5;
      Serial.println("Game End");
      Serial.println("***********************************");
   }
...
void right_4(){                      //좌3
  ...
  for(; a<=A+3; a++){
    ...
    if(cnt==4){
      ...
      showBlockcolor(4*(a-1)+1, 4*b+1, C0);
      showBlockcolor(4*a+1, 4*b+1, C0);
      blinkWinBlock(4*(a-3)+1, 4*(a-2)+1, 4*(a-1)+1, 4*a+1, 4*b+1, 4*b+1, 4*b+1, 4*b+1, C0);
      gamestatus = 5;
      Serial.println("Game End");
      Serial.println("***********************************");
   }
...
void bottom(){                       //하3
  ...
  for(; b<=B+3; b++){
    ...
    if(cnt==4){
      ...
      showBlockcolor(4*a+1, 4*b+1, C0);
      showBlockcolor(4*a+1, 4*(b-1)+1, C0);
      showBlockcolor(4*a+1, 4*(b-2)+1, C0);
      showBlockcolor(4*a+1, 4*(b-3)+1, C0);
      blinkWinBlock(4*a+1, 4*a+1, 4*a+1, 4*a+1, 4*b+1, 4*(b-1)+1, 4*(b-2)+1, 4*(b-3)+1, C0);
      gamestatus = 5;
      Serial.println("Game End");
      Serial.println("***********************************");
   }
...
void r_upcross_1(){                    //우상3
  ...
  for(; a<=A+3; a++,b++){
    ...
    if(cnt==4){
      ...
      showBlockcolor(4*a+1, 4*b+1, C0);
      showBlockcolor(4*(a+1)+1, 4*(b+1)+1, C0);
      showBlockcolor(4*(a+2)+1, 4*(b+2)+1, C0);
      showBlockcolor(4*(a+3)+1, 4*(b+3)+1, C0);
      blinkWinBlock(4*a+1, 4*(a+1)+1, 4*(a+2)+1, 4*(a+3)+1, 4*b+1, 4*(b+1)+1, 4*(b+2)+1, 4*(b+3)+1, C0);
      gamestatus = 5;
      Serial.println("Game End");
      Serial.println("***********************************");
   }
...
void r_upcross_2(){                  //좌하1우상2
  ...
  int cnt = 0;
    ...
    if(cnt==4){
      ...
      showBlockcolor(4*(a+1)+1, 4*(b+1)+1, C0);
      showBlockcolor(4*(a+2)+1, 4*(b+2)+1, C0);
      blinkWinBlock(4*(a-1)+1, 4*a+1, 4*(a+1)+1, 4*(a+2)+1, 4*(b-1)+1, 4*b+1, 4*(b+1)+1, 4*(b+2)+1, C0);
      gamestatus = 5;
      Serial.println("Game End");
      Serial.println("***********************************");
   }
...
void r_upcross_3(){                  //좌하2우상1
  ...
  int cnt = 0;
    ...
    if(cnt==4){
      ...
      showBlockcolor(4*a+1, 4*b+1, C0);
      showBlockcolor(4*(a+1)+1, 4*(b+1)+1, C0);
      blinkWinBlock(4*(a-2)+1, 4*(a-1)+1, 4*a+1, 4*(a+1)+1, 4*(b-2)+1, 4*(b-1)+1, 4*b+1, 4*(b+1)+1, C0);
      gamestatus = 5;
      Serial.println("Game End");
      Serial.println("***********************************");
   }
...
void r_upcross_4(){                  //좌하3
  ...
  int cnt = 0;
    ...
    if(cnt==4){
      ...
      showBlockcolor(4*(a-1)+1, 4*(b-1)+1, C0);
      showBlockcolor(4*a+1, 4*b+1, C0);
      blinkWinBlock(4*(a-3)+1, 4*(a-2)+1, 4*(a-1)+1, 4*a+1, 4*(b-3)+1, 4*(b-2)+1, 4*(b-1)+1, 4*b+1, C0);
      gamestatus = 5;
      Serial.println("Game End");
      Serial.println("***********************************");
   }
